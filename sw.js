/* v5.14.0 — network-first updates + offline shell, so installed PWA does not remain on stale UI. */
const VERSION='seowoo-v5.14.0';
const V='5.14.0';
const CORE=[
  '/', '/index.html', '/manifest.webmanifest', '/icons/icon-192.png', '/icons/icon-512.png',
  '/css/app.css','/css/v4.css','/css/v5.css','/css/v5-view.css','/css/pwa-v514.css',
